...
<span class="cat-links muted"><?php printf( __( 'Also posted in %s', 'blankslate' ), $catz ); ?></span>
<span class="meta-sep"> </span>
<?php else : ?>
<span class="cat-links"><span class="entry-footer-prep entry-footer-prep-cat-links muted">
